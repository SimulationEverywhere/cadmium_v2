/**
 * A DEVS interface for the Light Sensor on the Educational Boosterpack MK II
...
#ifndef LIGHT_SENSOR_INPUT_HPP
#define LIGHT_SENSOR_INPUT_HPP
    ...
    class LightSensorInput : public Atomic<LightSensorInputState> {
      public:
        ...
        LightSensorInput(const std::string& id): Atomic<LightSensorInputState>(id, LightSensorInputState())  {
            ...
            state.output = BSP_LightSensor_Input();
