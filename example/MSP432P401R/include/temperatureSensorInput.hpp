/**
 * A DEVS interface for the Temperature Sensor on the Educational Boosterpack MK II
...
#ifndef TEMPERATURE_SENSOR_INPUT_HPP
#define TEMPERATURE_SENSOR_INPUT_HPP
...
#endif // TEMPERATURE_SENSOR_INPUT_HPP
