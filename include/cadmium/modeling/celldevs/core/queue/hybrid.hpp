...
#ifndef CADMIUM_MODELING_CELLDEVS_CORE_QUEUE_HYBRID_HPP_
#define CADMIUM_MODELING_CELLDEVS_CORE_QUEUE_HYBRID_HPP_
...
#endif // CADMIUM_MODELING_CELLDEVS_CORE_QUEUE_HYBRID_HPP_
