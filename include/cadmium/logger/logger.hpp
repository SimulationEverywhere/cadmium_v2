...
namespace cadmium {
	class Logger {
	 ...
	 public:
		...
		virtual void stop() = 0;
		// TODO: I think the two log function should receive the object (i.e, model and port or portSet) then do the
		// TODO: logging. There is no need to go through the objects themselves. It adds indirection and limits
		// TODO: possibilities when specializing the logger.
