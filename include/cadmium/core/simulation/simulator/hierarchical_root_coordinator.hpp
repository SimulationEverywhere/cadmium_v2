...
#ifndef _CADMIUM_CORE_SIMULATION_FLAT_HIERARCHICAL_COORDINATOR_HPP_
#define _CADMIUM_CORE_SIMULATION_FLAT_HIEARACHICAL_ROOT_COORDINATOR_HPP_

#include <memory>
#include <utility>
#include <vector>
#include "flat_abstract_simulator.hpp"
