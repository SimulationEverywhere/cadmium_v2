...
#include <cadmium/celldevs/core/queue/inertial.hpp>
#include <cadmium/celldevs/core/queue/transport.hpp>
#include <cadmium/celldevs/core/queue/hybrid.hpp>

using namespace cadmium::celldevs;

BOOST_AUTO_TEST_CASE(inertial) {
	auto buffer = InertialOutputQueue<int>();
...
BOOST_AUTO_TEST_CASE(transport) {
	auto buffer = TransportOutputQueue<int>();
...
BOOST_AUTO_TEST_CASE(hybrid) {
	auto buffer = HybridOutputQueue<int>();
